...
root = Tk()
root.title('Merge Sort Algorithm ')
...
Label(UI_frame, text="برجاء عدم لمس البرنامج اثناء العمل 😁 😅  ", bg='grey').grid(row=2, column=0, padx=5, pady=5, sticky=W)
Label(UI_frame, text="By: Eslam Elsheikh ", bg='grey',font=('Times New Roman',10,'bold'),).grid(row=2, column=3, padx=5, pady=5, sticky=W)
